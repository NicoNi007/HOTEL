                               ...
                               //     sc.nextLine();
                                 switch (opcioCan) {
                                     case 1:
                                        ...
                                        Chekin.add(new Estada(Clients.get(i), hEntrada, hSortida, importss));
                                     ...
                                     case 6:
                                         ...
                                         System.out.println("L'import actual gastat del client " + Clients.get(i).getNom() +" es: " + Chekin.get(i).getImportActualGastat());
                                         break; 
                                     ...
                                     case 7:
                                            ...
                                            long dies = ChronoUnit.DAYS.between(Chekin.get(i).getDataEntrada(), Chekin.get(i).getDataSortida());
                                                ...
                                                PIVA = Chekin.get(i).getHabitacio().getPreuPerNit() * dies;
                                                impor = (PIVA * (1 + IVA));
